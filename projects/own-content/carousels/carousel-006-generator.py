...
OUTPUT_DIR    = Path("/Users/elibock/Desktop/ExecAss/projects/own-content/carousels/carousel-006")
...
slides = [
    {
        "number": 1,
        "type":   "title",
        "headline": "Wake Forest is Becoming a Major Real Estate Market",
    },
    {
        "number": 2,
        "type":   "content",
        "headline": "The Market Just Flipped to Buyers",
        "body":     "Inventory up 20.9%, days on market jumped from 66 to 86. If you've been positioning as a seller's agent, it's time to adapt.",
    },
    {
        "number": 3,
        "type":   "content",
        "headline": "You're Selling to Affluent, Educated Buyers",
        "body":     "Median household income $123K+, 58% hold bachelor's degrees. These buyers respond to data and sophistication, not hype.",
    },
    {
        "number": 4,
        "type":   "content",
        "headline": "It's the 8th Fastest-Growing City in North Carolina",
        "body":     "~7 new residents daily. Rapid growth + balanced market + high incomes = steady deal flow and opportunity.",
    },
    {
        "number": 5,
        "type":   "content",
        "headline": "Major Infrastructure Coming",
        "body":     "Federally funded rail project connecting Raleigh to Wake Forest. Development follows. Agents who see the trend win early.",
    },
    {
        "number": 6,
        "type":   "content",
        "headline": "Schools and Safety Close the Deal",
        "body":     "Crime 38% below state average, top-rated schools. These aren't just facts—they're the stories that sell homes to families.",
    },
    {
        "number": 7,
        "type":   "cta",
        "headline": "Follow for real estate market insights.",
