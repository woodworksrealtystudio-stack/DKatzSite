...
OUTPUT_DIR    = Path("/Users/elibock/Desktop/ExecAss/projects/own-content/carousels/carousel-005")
...
slides = [
    {
        "number": 1,
        "type":   "title",
        "headline": "Realtors are losing 30 minutes a day to call notes.",
    },
    {
        "number": 2,
        "type":   "content",
        "headline": "Your calls deserve better than transcripts.",
        "body":     "You're juggling the client, the details, and the follow-up. By the time the call ends, you're scrambling to remember the key points while your next client is already waiting.",
    },
    {
        "number": 3,
        "type":   "content",
        "headline": "Claude's voice feature changes the game.",
        "body":     "Speak your client call into Claude. It captures every word, understands context, and turns it into a clean summary you can send right back to your client. Hands-free. No typing.",
    },
    {
        "number": 4,
        "type":   "content",
        "headline": "Here's how it actually works.",
        "body":     "Call → Voice input (free transcription) → Claude summarizes → Ready to send. The transcription tokens don't even count against your usage limits.",
    },
    {
        "number": 5,
        "type":   "content",
        "headline": "You get your time back.",
        "body":     "Stop typing notes after hours. Your follow-ups are faster. Your clients feel heard because you're actually present with them. Your notes are organized. This is what AI should do for realtors.",
    },
    {
        "number": 6,
        "type":   "cta",
        "headline": "Follow for more AI strategies for realtors.",
